<template>
    <div class="p-6 bg-gray-100 min-h-screen">
      <!-- Page Header -->
      <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-800 mb-4">Forum Management</h1>
          ...
          <tbody class="text-gray-600 text-sm font-light">
            ...
            <tr class="border-b border-gray-200 hover:bg-gray-100">
              <td class="py-3 px-6 text-left whitespace-nowrap">
                <span class="font-medium">How to train a new puppy?</span>
              </td>
  ...
  function viewTopic() {
    ...
    alert("View Topic Details Coming Soon!");
  }
